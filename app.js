...
function buildReadme() {
  ...
  <h3>Verified against three EPFO IDS worksheets</h3>
  <ul>
    <li><strong>Baby S (UAN 100323502431)</strong> — PSB ₹839, FP ₹4,427, total ₹5,266, arrears ₹21,240. Exact match.</li>
    <li><strong>Sudhakar Sathyamoorthi (UAN 100365645183)</strong> — avg ₹14,796, FP ₹2,249 (EPFO: ₹2,250 ±₹1 NCP convention). Commencement 09-12-2023.</li>
    <li><strong>Santosh Kumar Shukla (UAN 102174391717)</strong> — PSB ₹1,229, FP ₹677, original ₹1,906 (EPFO: ₹1,906). Exact match. Commencement 12-01-2031.</li>
  </ul>`;
}
